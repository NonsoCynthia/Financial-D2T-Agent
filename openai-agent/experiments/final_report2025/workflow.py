...
def run(experiment_metadata: ExperimentMetadata, n_times: int = 3):
    ...
    for stock in STOCKS:
        ...
        print(
            f"[workflow] ticker={stock_id} start "
        ...
        for analysis_date in ANALYSIS_DATES:
            ...
            print(f"[workflow] ticker={stock_id} date={analysis_date} start")
            ...
            for experiment_id in range(n_times):
                ...
                if (
                    ...
                    if isinstance(existing_decision, dict):
                        ...
                        print(
                            f"[workflow] ticker={stock_id} date={analysis_date} run={experiment_id} "
        ...
        for experiment_id in range(n_times):
            ...
            if liquidation_event is not None:
                ...
                print(
                    f"[workflow] ticker={stock_id} date={final_date} run={experiment_id} "
